    ...
    return BlocProvider(
      ...
      child: BlocBuilder<BookCubit, BookState>(
        builder: (context, bookState) {
          bool isCompany = bookState.inn != null;
          return BlocConsumer<AddDriverCubit, AddDriverState>(
              ...
              if (state.status == StateStatus.error) {
                driverCubit.addDriverData(
                  ...
                  model: IndexedDriverModel(
                    isSuccess: isCompany ? true : false,
                    relativeSelected: isCompany ? true : false,
                  ),
                  ignoreRelative: isCompany,
                );
                showErrorMessage(
            ...
            builder: (context, state) {
              ...
              return BlocBuilder<DropDownValuesCubit, DropDownValuesState>(
                            ...
                            children2: [
                              Form(
                                ...
                                child: LimitlessDriverChild2Body(
                                  ...
                                  dropDownValues:
                                      dropDownState.relativeList.isNotEmpty
                                          ? (List.of(dropDownState.relativeList)
                                            ..removeAt(0))
                                          : [],
